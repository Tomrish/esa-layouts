...
const extension_1 = __importDefault(require("@esamarathon/esa-layouts-shared/restream/extension"));
...
const restream = new extension_1.default(nodecg_1.get(), true, nodecg_1.get().bundleConfig.restream);
